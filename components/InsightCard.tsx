...
import { BrainCog, BookOpen, ArrowRight, Link2 } from 'lucide-react'
      ...
      <Card className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border-gray-700 shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden">
        <CardContent className="p-0">
          ...
          <div className="p-4 space-y-4">
            ...
            {/* Citation with enhanced visibility */}
            {citation && (
              <div className="mt-4 bg-blue-950/30 rounded-lg p-3 border border-blue-500/20">
                <div className="flex items-start gap-2">
                  <Link2 className="h-4 w-4 text-blue-400 mt-1" />
                  <div className="flex-1">
                    <span className="text-blue-400 text-sm font-medium block mb-1">Referência</span>
